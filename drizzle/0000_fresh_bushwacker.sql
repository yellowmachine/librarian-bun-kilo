...
CREATE POLICY "user_profile_select" ON "librarian"."user_profile" AS PERMISSIVE FOR SELECT TO "scholio_app" USING ("librarian"."user_profile"."user_id" = current_setting('app.current_user_id', true));--> statement-breakpoint
